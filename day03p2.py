...
def solve():
    ...
    grid1 = [[0 for i in range(20000)] for i in range(20000)]
    currR = 10000
    currC = 10000
    grid1Step = 1
    for move in wire1:
        val = int(move[1:])
        if(move[0] == 'R'):
            for i in range(currC + 1, currC + val + 1):
                grid1[currR][i] = grid1Step
                grid1Step += 1
            currC += val
        elif(move[0] == 'L'):
            for i in range(currC - 1, currC - val - 1, -1):
                grid1[currR][i] = grid1Step
                grid1Step += 1
            currC -= val
        elif(move[0] == 'U'):
            for i in range(currR - 1, currR - val - 1, -1):
                grid1[i][currC] = grid1Step
                grid1Step += 1
            currR -= val
        elif(move[0] == 'D'):
            for i in range(currR + 1, currR + val + 1):
                grid1[i][currC] = grid1Step
                grid1Step += 1
            currR += val
    
    grid2 = [[0 for i in range(20000)] for i in range(20000)]
    currR = 10000
    currC = 10000
    grid2Step = 1
    ...
    for r in range(20000):
        for c in range(20000):
            if grid1[r][c] != 0 and grid2[r][c] != 0:
                result = min(result, grid1[r][c] + grid2[r][c])
    print(result)
